...
const INSTRUCTION_ROWS = [
  ...
  { label: 'Purpose of transfer', value: 'Gift' },
  {
    label: 'Note summary',
    value:
      'I, Matthew Hughes, spoke with Jim Robinson on May 1, 2025, at 10:45 AM. He requested a $250,000.00 ACH transfer to account number ending in 2312.',
    multiline: true,
  },
]
...
export default function ReviewPage() {
  ...
  const confirmationPath = `/account/${accountId}/move-money/outbound/confirmation`
