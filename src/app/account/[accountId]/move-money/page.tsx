...
type TransferStatus = 'awaiting_signature' | 'processed' | 'rejected' | 'pending'
  ...
  return (
    <div className="space-y-7 pb-3">
      ...
      <div className="space-y-5">
        ...
        <div className="flex gap-16 items-center pl-11">
          {/* Transfer type buttons */}
          <div className="flex gap-4 px-1">
            {/* Outbound */}
            <button className="flex flex-col items-center gap-5 group cursor-pointer">
          ...
          {/* Funds card */}
          <Card className="w-[566px] px-8 py-6 flex flex-col gap-4">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-muted/60 rounded-lg">
                ...
                <th className="text-right py-2 px-2 font-medium text-muted-foreground text-sm">Request amount</th>
              ...
              {MOCK_TRANSFERS.map((t) => {
                ...
                return (
                  <tr key={t.id} className="border-b last:border-0 h-24 group hover:bg-muted/30 cursor-pointer">
                    ...
                    <td className="py-2 px-2 text-right">{formatCurrency(t.requestAmount)}</td>
