  ...
  return (
    <TooltipProvider>
      <div className="w-full">
        ...
        <div>
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-lg font-semibold">All tax lots</h2>
            <div className="flex gap-2">
            ...
            <table className="w-full text-sm min-w-[1600px]">
              <thead>
                <tr className="border-b">
                  <th className={`text-left px-6 py-3 font-medium text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-muted/50 border-r ${sortColumn === 'lastUpdated' ? 'border-b-2 border-b-primary' : ''}`}>
                  ...
                  <th className={`text-left px-6 py-3 font-medium text-muted-foreground cursor-pointer hover:bg-muted/50 border-r max-w-[200px] ${sortColumn === 'symbol' ? 'border-b-2 border-b-primary' : ''}`}>
                  ...
                  <th className={`text-center px-6 py-3 font-medium text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-muted/50 border-r ${sortColumn === 'longShort' ? 'border-b-2 border-b-primary' : ''}`}>
                  ...
                  <th className={`text-right px-6 py-3 font-medium text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-muted/50 border-r ${sortColumn === 'unrealizedGL' ? 'border-b-2 border-b-primary' : ''}`}>
                  ...
                  <th className={`text-right px-6 py-3 font-medium text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-muted/50 border-r ${sortColumn === 'unrealizedGLPercent' ? 'border-b-2 border-b-primary' : ''}`}>
                  ...
                  <th className={`text-right px-6 py-3 font-medium text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-muted/50 border-r ${sortColumn === 'avgPrice' ? 'border-b-2 border-b-primary' : ''}`}>
                  ...
                  <th className={`text-right px-6 py-3 font-medium text-muted-foreground whitespace-nowrap cursor-pointer hover:bg-muted/50 border-r ${sortColumn === 'currentPrice' ? 'border-b-2 border-b-primary' : ''}`}>
                ...
                {filteredPositions.length === 0 ? (
                  ...
                  filteredPositions.map((position, index) => (
                    <tr key={position.id} className={`border-b ${index % 2 === 1 ? 'bg-card' : ''}`}>
                      ...
                      <td className="px-6 py-3 text-foreground max-w-[200px] truncate">{position.description}</td>
